...
1. You might want to move this folder into the kodi addon folder for convenience when debugging. It might also be needed to be `enabled` inside of the kodi addon browser.
